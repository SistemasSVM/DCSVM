            ...
            <table width="100%">
                <tr>
                    <td width="25%" valign="top"> <!-- Esto hace que la celda ocupe la mitad de la tabla -->
                        <form method="POST" action="guardar_departamento.php" enctype="multipart/form-data" id="guardar">
    ...
    function eliminarRegistro(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                xhr.open("GET", "./delete-files/eliminar_dep.php?id=" + id, true);
                xhr.onload = function () {
                    if (xhr.status === 200) {
...
<script>
    $(document).ready(function() {
        $('#guardar').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: './register_files/guardar_departamento.php',
